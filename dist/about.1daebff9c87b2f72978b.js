...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <p class=\"feedback_text "
    + alias4(((helper = (helper = helpers.feedbackLength || (depth0 != null ? depth0.feedbackLength : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"feedbackLength","hash":{},"data":data}) : helper)))
    + "\">"
...
var slick = __webpack_require__(38);

// EXTERNAL MODULE: ./node_modules/slick-carousel/slick/slick-theme.scss
var slick_theme = __webpack_require__(39);

// EXTERNAL MODULE: ./src/page-about/page-about.scss
var page_about = __webpack_require__(40);

// CONCATENATED MODULE: ./src/page-about/apiAbout.js
...
function getPosterLittle(id) {
  const url = `${baseUrl}/movie/${id}?api_key=${api_key}&append_to_response=backdrop_path`;
  return fetch(url).then(res => res.json());
}
// EXTERNAL MODULE: ./src/page-about/infoList.hbs
var infoList = __webpack_require__(26);
var infoList_default = /*#__PURE__*/__webpack_require__.n(infoList);

// EXTERNAL MODULE: ./src/page-about/actorsList.hbs
var actorsList = __webpack_require__(27);
var actorsList_default = /*#__PURE__*/__webpack_require__.n(actorsList);

// EXTERNAL MODULE: ./src/page-about/framesList.hbs
var framesList = __webpack_require__(28);
var framesList_default = /*#__PURE__*/__webpack_require__.n(framesList);

// EXTERNAL MODULE: ./src/page-about/reviewsList.hbs
var page_about_reviewsList = __webpack_require__(29);
var reviewsList_default = /*#__PURE__*/__webpack_require__.n(page_about_reviewsList);
...
var slick_slick = __webpack_require__(41);

// CONCATENATED MODULE: ./src/page-about/page-about.js
...
class page_about_PageAbout {
  ...
  markupInfoList() {
    getMovie(this.movieId).then(movieInfoRes => {
      const markup = infoList_default()(movieInfoRes);
  ...
  markupActors() {
    getMovieActors(this.movieId).then(data => {
      const markup = actorsList_default()(data.credits.cast);
      this.refs.actorsList.insertAdjacentHTML("afterbegin", markup);
      jquery_default()(".actors-list").slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        arrows: false,
        autoplay: true,
  ...
  markupFrames() {
    getMovieFrames(this.movieId).then(data => {
      const markup = framesList_default()(data.backdrops);
      this.refs.framesList.insertAdjacentHTML("afterbegin", markup);
      jquery_default()(".frames-list").slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        arrows: false,
        autoplay: true,
  ...
  markupReviews() {
    getMovieReviews(this.movieId).then(data => {
      ...
      const markup = reviewsList_default()(reviewsList);
  ...
  showMoreReviewText() {
    this.refs.reviewsList.addEventListener("click", e => {
      if (e.target.nodeName === "BUTTON" && e.target.textContent === "...more") {
        const hiddenSpan = document.querySelector('.hidden_text');
        hiddenSpan.classList.add("show_text");
        e.target.textContent = "collapse";
      } else if (e.target.nodeName === "BUTTON" && e.target.textContent === "collapse") {
        const hiddenSpan = document.querySelector('.hidden_text');
...
const pageAbout = new page_about_PageAbout(localStorage.getItem('id'));
// CONCATENATED MODULE: ./src/page-about/main.js
// import '../scss/nav.scss';
// import '../scss/main.scss';
 // import './page.scss';
// import '../partials/menu-burger.js';
// import '../page-index/api.js';
// import '../page-index/search.js';
// import '../scss/subscription.scss';
// import '../partials/subscription.js';

 // import '../partials/elementActive.js';
// import '../partials/upArrow.js';
