...
shadowBox.addEventListener("click", closeBurgerWindow); // const filmsButton = document.querySelector('.burger__list');
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <img class=\"movie-logo\" src=\"https://image.tmdb.org/t/p/w500"
    ...
    return "\n    <img class=\"movie-logo\" src=\"img/not-found.png\" alt=\"movie-title\"> ";
  ...
  return " "
    ...
    + " ("
    + alias4(((helper = (helper = helpers.first_air_date || (depth0 != null ? depth0.first_air_date : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"first_air_date","hash":{},"data":data}) : helper)))
    + ") ";
},"10":function(container,depth0,helpers,partials,data) {
    return "  <svg class=\"svg-star svg-green\">\n";
},"12":function(container,depth0,helpers,partials,data) {
    return "    <svg class=\"svg-star\">\n";
...
// EXTERNAL MODULE: ./src/scss/nav.scss
...
// EXTERNAL MODULE: ./src/page-index/page.scss
var page = __webpack_require__(32);

// EXTERNAL MODULE: ./src/partials/menu-burger.js
var menu_burger = __webpack_require__(23);
...
/* harmony default export */ var apiSearchMovie = ({
  ...
  fetch() {
    ...
    return fetch(baseUrl + requestParam).then(res => res.json()).then(parseRes => {
      return parseRes.results;
    });
  }

});
// CONCATENATED MODULE: ./src/apiPopular.js
const apiPopular_baseUrl = 'https://api.themoviedb.org/3/';
/* harmony default export */ var apiPopular = ({
  key: '667e6c0579f71e858d539ca597385526',
  type: '',
  page: 1,
  language: 'en-US',
...
// EXTERNAL MODULE: ./src/partials/popular.hbs
var popular = __webpack_require__(25);
var popular_default = /*#__PURE__*/__webpack_require__.n(popular);

// CONCATENATED MODULE: ./src/sortFunct.js
// sort By Name Title
...
// EXTERNAL MODULE: ./src/page-index/search.js
var search = __webpack_require__(24);

// CONCATENATED MODULE: ./src/page-index/api.js
...
refs.gallery.addEventListener('click', movieSelected); // BUILD MAIN PAGE LIST
...
const openlightbox = document.querySelector(".lightbox");
const lightboxShadow = document.querySelector(".lightbox_shadow"); // SEARCH FILM
...
function searchSbm(e) {
  ...
  apiSearchMovie.fetch().then(result => {
    clearListItemFilm();
    itemGallery = result;
    insertMarkup(result);
  });
  ...
  if (getItemLocStor === null || getItemLocStor === undefined) {
    ...
    [...idFromDom].forEach(el => {
      ...
      if (idFromLocStor.includes(idCurrentElement)) {
        el.classList.add('svg-green'); // el.closest('.movie').remove();
      } else {
...
// EXTERNAL MODULE: ./src/scss/subscription.scss
var subscription = __webpack_require__(33);

// EXTERNAL MODULE: ./src/partials/subscription.js
var partials_subscription = __webpack_require__(34);

// EXTERNAL MODULE: ./src/scss/footer.scss
var footer = __webpack_require__(22);

// CONCATENATED MODULE: ./src/partials/elementActive.js
...
//   }
// }
// EXTERNAL MODULE: ./src/partials/upArrow.js
var upArrow = __webpack_require__(35);

// EXTERNAL MODULE: ./src/scss/upArrow.scss
var scss_upArrow = __webpack_require__(36);

// EXTERNAL MODULE: ./src/scss/select.scss
var scss_select = __webpack_require__(37);

// CONCATENATED MODULE: ./src/page-index/main.js
...
/***/ })
/******/ ]);
//# sourceMappingURL=index.0a473932babb1bba3b44.js.map